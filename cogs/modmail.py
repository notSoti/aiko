...
#
    ...
    async def spotify(self, ctx, member:discord.Member=None):
        ...
        embed = discord.Embed(color=ctx.author.color, title="Spotify", timestamp=discord.utils.utcnow())
        ...
        for activity in member.activities:
            if isinstance(activity, Spotify):
                ...
                embed.add_field(name="Song", value=f"[{activity.title}]({activity.track_url})", inline=False)
    ...
    async def theme(self, ctx, icon: str = None):
        ...
        await nyanko.edit(name=f"{emoji4}┆nyankos-corner•₊°")
        ...
        await links.edit(name=f"╰ʚ{emoji2}﹕links・๑•͈ᴗ•͈")
